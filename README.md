...
**[Live demo →](https://creditlens-seven.vercel.app)** · [Score an application](https://creditlens-seven.vercel.app/score/) · [Cutoff simulator](https://creditlens-seven.vercel.app/portfolio/) · [Fairness](https://creditlens-seven.vercel.app/fairness/)
...
The [live dashboard](https://creditlens-seven.vercel.app) runs entirely on
pre-computed snapshots of these artifacts, so it works with no backend running.
The cutoff simulator recomputes client-side against 4,000 out-of-time
applications carrying **realised** outcomes — the bad rate it shows at each
cutoff is observed, not predicted.
